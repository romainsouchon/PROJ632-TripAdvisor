...
#URL = 'https://www.tripadvisor.fr/Restaurant_Review-g678215-d3250598-Reviews-Restaurant_La_Boussole-Sevrier_Haute_Savoie_Auvergne_Rhone_Alpes.html'
...
def get_users():   #cette méthode retourne tous les users des autres pages   
    for i in range(10,(nbre_de_pages)*10 -20 ,10):
        #Brasserie le Z
        ...
        #URL_reviews = 'https://www.tripadvisor.fr/Restaurant_Review-g678215-d3250598-Reviews-or' + str(i) + '-Restaurant_La_Boussole-Sevrier_Haute_Savoie_Auvergne_Rhone_Alpes.html'
